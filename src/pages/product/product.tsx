...
import { selectCameraById, selectDoesCameraByIdLoading, selectSimilarCameras } from '../../store/cameras/cameras.selectors';
...
export const Product = () => {
  ...
  const doesCameraByIdLoading = useAppSelector(selectDoesCameraByIdLoading);
  const similarCameras = useAppSelector(selectSimilarCameras);
  const doesSimilarCamerasLoading = useAppSelector(selectDoesCameraByIdLoading);
  ...
  const doesProduceActive = (index: number) => {
  ...
  if (doesCameraByIdLoading) {
    return <div>LOADING</div>
  }

  console.log('reviews', reviews);
  // console.log('reviewsToShow', reviewsToShow);
  // console.log('reviewsRemained', reviewsRemained);
  // console.log('currentCamera', camera);
  // console.log("similarCameras", similarCameras);
            ...
            <div className="container">
              ...
              <div className="product-similar__slider">
                <div className="product-similar__slider-list">
                  ...
                  {doesSimilarCamerasLoading ? <div>LOADING</div> :
                              
                  similarCameras.map((camera, index) => (
                    <div key={camera.id} className={classNames("product-card", {"is-active": doesProduceActive(index) })}>
